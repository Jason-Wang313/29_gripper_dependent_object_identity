...
\midrule
\input{tables/full_scale_main_performance.tex}
\end{tabular}
\end{table}
...
Strategy & Aligned & Baseline & Hidden 1 & Hidden 2 & Global obs. \\
\midrule
\input{tables/full_scale_main_utility.tex}
\end{tabular}
\end{table}
...
\midrule
\input{tables/full_scale_phase_winners.tex}
\end{tabular}
\end{table}
...
\midrule
\input{tables/full_scale_learned_partition.tex}
\end{tabular}
\end{table}
...
\midrule
\input{tables/full_scale_non_nesting.tex}
\end{tabular}
\end{table}
...
\midrule
\input{tables/full_scale_transfer_matrix.tex}
\end{tabular}
}
\end{table}
...
\midrule
\input{tables/full_scale_controls.tex}
\end{tabular}
\end{table}
